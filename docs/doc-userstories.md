...
| US03 | Excluir cliente                     | Como administrador, quero remover clientes para manter o sistema organizado | RF01              | Jadson     |
| US04 | Cadastrar equipamento               | Como atendente, quero cadastrar equipamentos para registrar itens do cliente | RF02             | Mariana    |
| US05 | Vincular equipamento ao cliente     | Como atendente, quero associar equipamentos a clientes para controle      | RF02                 | Jadson     |
